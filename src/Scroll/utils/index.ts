...
export function getScrollXThumbOffset(dom: any, scrollLeft: any) {
    ...
    const scrollXThumbOffset = scrollLeft / ((scrollWidth - clientWidth) / (clientWidth - scrollXThumbWidth))
...
export function getScrollYThumbOffset(dom: any, scrollTop: any) {
    ...
    const scrollYThumbOffset = scrollTop / ((scrollHeight - clientHeight) / (clientHeight - scrollYThumbHeight))
...
export function getScrollLeftByThumbOffset(dom: any, scrollXThumbOffset: any) {
    ...
    const scrollLeft = ((scrollWidth - clientWidth) / (clientWidth - scrollXThumbWidth)) * scrollXThumbOffset;
    return scrollLeft;
}
...
export function getScrollTopByThumbOffset(dom: any, scrollYThumbOffset: any) {
    ...
    const scrollTop = ((scrollHeight - clientHeight) / (clientHeight - scrollYThumbHeight)) * scrollYThumbOffset;
    return scrollTop;
}
